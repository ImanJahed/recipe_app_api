...
@extend_schema_view(
    list=extend_schema(
        OpenApiParameter(
            'tags',
            OpenApiTypes.STR,
            description="Comma separated list of tags ID's for filter"
        ),
        OpenApiParameter(
            'ingredients',
            OpenApiTypes.STR,
            description="Comma separated list of ingredients ID's for filter"
        )
    )
)
class RecipeViewSet(viewsets.ModelViewSet):
    ...
    def _params_to_int(self, qs):
        """Convert list of string params to integers"""
